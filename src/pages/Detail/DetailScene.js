...
import {Heading1, Heading2, Heading3, Paragraph} from '@app/components/Text'
import api, {recommendUrlWithId, groupPurchaseDetailWithId} from '@app/services/api'
...
class GroupPurchaseScene extends PureComponent<Props, State> {
    ...
    static navigationOptions = ({navigation}: any) => ({
        ...
        headerRight: (
            <NavigationItem
                icon={require('@app/assets/images/public/icon_navigation_item_share.png')}
                onPress={() => {
            ...
            <View>
                ...
                <View>
                    <View style={styles.tagContainer}>
                        <Image style={{width: 20, height: 20}} source={require('@app/assets/images/home/icon_deal_anytime_refund.png')} />
